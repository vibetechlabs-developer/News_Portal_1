...
# Email (contact form + password reset + careers acceptance)
# Default backend prints to the console only — no real delivery until you set SMTP in .env.
...
# Gmail: use an App Password on the sending account; enable 2FA first.
...
DEFAULT_FROM_EMAIL = config(
    "DEFAULT_FROM_EMAIL",
    default=(EMAIL_HOST_USER if EMAIL_HOST_USER else "noreply@newsportal.local"),
)
