...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Defaults tuned for long forms: keep dialog within viewport and allow internal scrolling.
        // Individual dialogs can override by passing their own max-h/overflow classes.
